...
## 🛠️ Compétences en un coup d'œil

### 📞 Soutien & Résolution de problèmes
*   **Support de niveau 1** : Prise en charge des demandes de service, diagnostic et résolution d'incidents (sur place ou à distance).
*   **Documentation technique** : Rédaction de guides de dépannage et création de procédures de soutien pour l'amélioration continue.

### 🏢 Environnement Microsoft Moderne & Administration
*   **Systèmes d'exploitation** : Maîtrise avancée de Windows 10/11.
*   **Outils Collaboratifs** : Gestion et support de l'écosystème Microsoft 365 (Teams, SharePoint, OneDrive, Outlook).
*   **Gestion des accès** : Administration de base des comptes utilisateurs, des permissions et de la sécurité informatique.
